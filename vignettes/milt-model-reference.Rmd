...
Repeats the training-series mean for every forecast step, with a constant
(non-widening) prediction interval — appropriate when the series has no
trend or seasonality and residuals are assumed i.i.d.
...
autoregressively slides that window forward using its own forecasts — so the
h-step-ahead forecast eventually becomes the mean of prior forecasts alone.
